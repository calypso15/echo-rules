...
| [Deep Anchor](#deep-anchor)                     |    2    | Resonants only. +10 vs. further Watcher entanglement, higher dependent upon Resonance Rating.                                                                                                                       |
...
| [Resonance](#resonance)                         |   2/4   | May use Resonance skill and manifestations. See text for additional rules.                                                                                                                                          |
| [Resonance Camouflage](#resonance-camouflage)   |   1/2   | −10 to detect with resonance per level.                                                                                                                                                                             |
| [Resonance Defense](#resonance-defense)         |   1/2   | +10 to resist resonance per level.                                                                                                                                                                                  |
...
| [Zoosemiotics](#zoosemiotics)                   |    1    | No modifier using resonance on non- or partly-sapient animals.                                                                                                                                                      |

</blockquote>

_\* Not available in Echo Protocol ([Traits](28-traits-changes.md))._
...
| [Resolve](#resolve)                               |  1/2/3  | +5 per level to WIL Checks.                                                     |
| [Resonance Camouflage](#resonance-camouflage)     |   1/2   | −10 to detect with resonance per level. Bio-brained morphs only.                |
| [Resonance Defense](#resonance-defense)           |   1/2   | +10 to resist resonance per level. Bio-brained morphs only.                     |
...
_\* Not available in Echo Protocol ([Traits](28-traits-changes.md)). Exception: characters with the Lost background may take Skill Artifact._
...
> In Echo Protocol, allies are drawn from the setting's factions and organizations — a dive crew, a guild chapter, a CMC cell, a Pure Earth chapter, or another group from the world.
...
> In Echo Protocol, contacts are tied to the setting's factions, institutions, and networks. See [Reputation & Money](../15/12-reputation-changes.md).
...
This trait is only available to characters with the Resonance trait. Your resonance baseline is deeply stable and aggressively resists further Watcher entanglement. You receive a +10 modifier to resist resonance exposure events. Increase this to +20 if your Resonance Rating is 33 or more, +30 if it is 66 or more.

> In Echo Protocol, this trait replaces **Dominant Strain** from the base game. See [Resonance](../14/00-psi-changes.md).
...
You are accustomed to trauma, but it has scarred you. You are immune to stress from either alienation, helplessness, the unknown, or violence (choose one p. 229). You may only choose the unknown if you also have the Resonance trait. Your WIL Check is reduced by 10 and you suffer a −10 modifier on Persuade Tests. This trait may be taken multiple times for different types of stress; modifiers are cumulative.

> In Echo Protocol, Hardening is grimmer than in most campaigns. There are no backups. What you harden against, you harden against permanently — it is scar tissue, not a calculated trade-off.
...
> In Echo Protocol, patrons come from the setting's power structures — a senior guild officer, a CMC program director, an Accord official, a black-market dealer, or another influential figure from the world.
...
You are sensitive to the Watcher-derived resonance phenomena that surface in deep environments. You may learn the [Resonance skill](19-active-skill-list.md#resonance) and access resonance manifestations. At Level 1, you may only use passive manifestations. At Level 2, you may use both passive and active manifestations.

Resonance is not without drawbacks. You must also take a negative trait according to your resonance profile at no CP bonus. This required trait does not count towards trait CP limits.

> In Echo Protocol, this trait replaces **Psi** from the base game. See [Resonance](../14/00-psi-changes.md) for the full system.

### Resonance Camouflage

**▲ Ego or ▼ Morph Trait • CP/MP Cost: 1/2**

You are more difficult to detect with resonance sensing. Apply a −10 modifier per level to any attempts to locate or detect you via resonance manifestations. The morph trait may only be taken by morphs with biological brains.

> In Echo Protocol, this trait replaces **Psi Camouflage** from the base game.

### Resonance Defense

**▲ Ego or ▼ Morph Trait • CP/MP Cost: 1/2**

Your mind is inherently resistant to resonance effects and entanglement. Apply a +10 modifier per level to defense rolls against resonance manifestations. The morph trait is only available to morphs with biological brains.

> In Echo Protocol, this trait replaces **Psi Defense** from the base game.
...
> In Echo Protocol, Resources works as written. All costs and wealth levels are denominated in milliAU (m₳). See [Reputation & Money](../15/12-reputation-changes.md).
...
You laugh at fear. Apply a +10 modifier per level to WIL Checks and other tests that involve resisting fear, such as Provoke Tests for intimidation, resonance manifestations such as Nightmare, and some Stress Tests (GM Discretion; typically the unknown but sometimes helplessness or violence).
...
This trait is only available to characters possessing the Resonance trait. You do not suffer modifiers when using resonance manifestations on non-sapient or partly sapient animal species.

> In Echo Protocol, this trait applies to Resonance manifestations rather than psi sleights.
...
| [Registered](#registered)                       |   1/2    | Your Resonance profile is in a registry. See text.                            |
| [Resonance Sensitivity](#resonance-sensitivity) |   1/2    | −10 per level to resist resonance effects.                                    |
...
_\* Not available in Echo Protocol ([Traits](28-traits-changes.md)). Exception: characters with the Lost background may take Edited Memories._
...
| [Indifference](#indifference)                     |  1/2/3   | −5 per level to SAV Checks.                                                                                                 |
| [Exposure Risk](#exposure-risk)                   |   1/2    | −10 per level to SOM Checks to resist resonance exposure effects.                                                           |
...
| [Resonance Sensitivity](#resonance-sensitivity)   |   1/2    | −10 per level to resist resonance. Bio-brained morphs only.                                                                 |
| [Restricted Behavior](#restricted-behavior)       |  1/2/4   | Psychosurgically limited behavior/emotions. See text.                                                                       |
...
_\* Not available in Echo Protocol ([Traits](28-traits-changes.md)). Exception: characters with the Lost background may take Memory Artifact._
...
> In Echo Protocol, age is fully in play — rejuvenation technology does not exist. An aged morph is simply old, with no expectation of renewal. This is not unusual or remarkable in 2047.
...
> In Echo Protocol, use the remapped reputation networks and factions. See [Reputation & Money](../15/12-reputation-changes.md).
...
> In Echo Protocol, use the remapped reputation networks. See [Reputation & Money](../15/12-reputation-changes.md).
...
> In Echo Protocol, this trait is not available — psychosurgical memory editing does not exist. Exception: characters with the Lost background may take this trait to represent memories fragmented or suppressed by early resonance exposure.
...
> In Echo Protocol, enemies come from the setting's factions — a CMC enforcer, a rival diver, a Pure Earth operative, a guild rival, an Accord official, or another figure from the world.
...
> In Echo Protocol, this trait is only valid for the Neo-Octopus morph, the sole non-humanoid allowed in the default setting.
...
Your morph is particularly susceptible to Watcher-derived resonance exposure. Apply a −10 modifier per level to SOM Checks made to resist resonance exposure effects. This trait is only available for biomorphs.

> In Echo Protocol, this trait replaces **Infection Risk** from the base game. It represents neurological susceptibility to Watcher influence rather than biological exsurgent virus infection.
...
> In Echo Protocol, this trait is not available in the standard setting. Exception: characters with the Lost background may take this trait to represent fragmented resonance impressions left by previous divers who wore the same gear or traversed the same deep sites.
...
**▲ Negative Ego Trait • CP Bonus: 1/2**

Your Resonance profile is on file in an official registry. You didn't necessarily choose this — most licensed Resonant divers are automatically enrolled when they receive their diving certification.

**Level 1:** Your profile is in a national or Accord-wide database. Automated security screenings flag you, border crossings take longer, and institutional recruiters know your tier. Day-to-day life is largely unaffected; it's the friction at checkpoints and bureaucratic chokepoints that adds up.

**Level 2:** You are flagged as high-value. A state program, CMC talent-acquisition office, or something worse actively tracks your movements and associations. Staying off their radar requires active effort.

Most legally licensed Resonant divers have Level 1 whether they like it or not; taking the CP means it actually matters at your table.

### Resonance Sensitivity

**▲ Ego or ▼ Morph Trait • CP/MP Bonus: 1/2**

Your neural structure is particularly susceptible to resonance effects. Apply a −10 modifier per level when resisting resonance manifestations. The morph trait may only be taken by morphs with biological brains.

> In Echo Protocol, this trait replaces **Psi Vulnerability** from the base game.
...
> In Echo Protocol, this is a particularly rough trait for Operators, who spend extended periods in virtual dive interfaces managing systems and crew during active operations.
