...
_Echo Protocol: Biomods reskin as the Watcher-derived gene-therapy package standard in enhanced morphs (splicer and up): you heal faster (use the book's biomorph healing rates), have strong disease resistance, do not suffer shock reactions, and can trigger contraception at will. Strike the rest — no aging immunity, no limb regeneration, no 4-hour sleep (Circadian Regulation is prohibited), and the zero-g clauses are moot. Flats lack biomods, like most of Earth's population._
